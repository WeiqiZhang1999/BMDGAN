#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2/17/2023 7:57 PM
# @Author  : ZHANG WEIQI
# @File    : IFormerModel.py
# @Software: PyCharm

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 1/20/2023 1:07 PM
# @Author  : ZHANG WEIQI
# @File    : InceptionTransformer.py
# @Software: PyCharm
...
class LowMixer(nn.Module):
    ...
    def forward(self, x):
        ...
        xa = xa.view(B, C, int((N*2) ** 0.5), int((N*2) ** 0.5) // 2)  # .permute(0, 3, 1, 2)
...
class InceptionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=1, embed_dims=None, depths=None,
...
@register_model
def iformer_base(pretrained=False, embed_dims = [96, 192, 384, 512], **kwargs):
    """
    ...
    model = InceptionTransformer(img_size=256,
                                 depths=depths,
                                 embed_dims=embed_dims,
                                 num_heads=num_heads,
                                 attention_heads=attention_heads,
