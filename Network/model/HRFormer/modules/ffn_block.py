...
class MlpDWBN(nn.Module):
    def __init__(
        ...
        self.norm1 = LayerHelper.get_norm_layer(num_features=hidden_features, norm_type=norm_type)
        self.dw3x3 = nn.Conv2d(
            hidden_features,
            hidden_features,
            kernel_size=3,
        ...
        self.norm2 = LayerHelper.get_norm_layer(num_features=hidden_features, norm_type=norm_type)
        self.fc2 = nn.Conv2d(hidden_features, out_features, kernel_size=1)
        self.act3 = act_layer()
        # self.norm3 = nn.BatchNorm2d(out_features)
        self.norm3 = LayerHelper.get_norm_layer(num_features=out_features, norm_type=norm_type)
...
class MlpWODWBN(nn.Module):
    def __init__(
        ...
        out_features = out_features or in_features
        hidden_features = hidden_features or in_features
        self.fc1 = nn.Conv2d(in_features, hidden_features, kernel_size=1, padding_mode=padding_type)
        self.act1 = act_layer()
        # self.norm1 = nn.BatchNorm2d(hidden_features)
        self.norm1 = LayerHelper.get_norm_layer(num_features=hidden_features, norm_type=norm_type)
        self.fc2 = nn.Conv2d(hidden_features, out_features, kernel_size=1, padding_mode=padding_type)
        self.act3 = act_layer()
        # self.norm3 = nn.BatchNorm2d(out_features)
        self.norm3 = LayerHelper.get_norm_layer(num_features=out_features, norm_type=norm_type)
        self.drop = nn.Dropout(drop)
