...
class MAE(nn.Module):
    def __init__(
        ...
        self.pixel_values_per_patch = encoder.patch_size * encoder.patch_size * 3
    ...
    def forward(self, img):
        ...
        encoded_tokens = self.encoder.forward(tokens, pretrain=True)
...
if __name__ == '__main__':
    ...
    from Restormer import RestormerEncoder
