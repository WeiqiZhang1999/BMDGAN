...
class ViTEncoder(nn.Module):
    def __init__(self, image_size: Union[Tuple[int, int], int], patch_size: Union[Tuple[int, int], int],
        ...
        self.to_patch_embedding = nn.Sequential(
            nn.Conv2d(channels, dim, kernel_size=patch_size, stride=patch_size, padding=1),
...
class ViTDecoder(nn.Module):
    def __init__(self, image_size: Union[Tuple[int, int], int], patch_size: Union[Tuple[int, int], int],
        ...
        self.to_pixel = nn.Sequential(
            ...
            nn.ConvTranspose2d(dim, channels, kernel_size=patch_size, stride=patch_size, padding=1)
        )
