#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2/26/2023 10:25 PM
# @Author  : ZHANG WEIQI
# @File    : BMDGAN2Model.py
# @Software: PyCharm
import itertools
...
from Network.model.HRFormer.HRFormer2Block import HighResolutionTransformer
...
class BMDGAN2Model(TrainingModelInt):
...
class BMDGAN2ModelInference(InferenceModelInt):
